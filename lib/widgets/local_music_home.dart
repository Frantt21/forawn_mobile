  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<Song?>(
      ...
      builder: (context, songSnapshot) {
        ...
        return Stack(
          children: [
            // Background Gradient (YT Music Style)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (recentPlaylists.isNotEmpty) ...[
                        ...
                        SizedBox(
                          height: 156, // Ajustado para formato cuadrado
...
class _AnimatedPlayingIndicator extends StatefulWidget {
  final Color color;
  const _AnimatedPlayingIndicator({required this.color});

  @override
  State<_AnimatedPlayingIndicator> createState() =>
      _AnimatedPlayingIndicatorState();
}

class _AnimatedPlayingIndicatorState extends State<_AnimatedPlayingIndicator>
    with SingleTickerProviderStateMixin {
  ...
  Widget _buildBar(int index, bool isPlaying) {
    // Si no está reproduciendo, mostrar altura fija (estático)
    // Si está reproduciendo, animar
